...
WEBHOOK_URL = 'https://097f773f.ngrok.io/hook'
...
def _set_webhook():
    status = bot.set_webhook("https://097f773f.ngrok.io/hook")
    if not status:
        print('Webhook setup failed')
        sys.exit(1)
    else:
        print('Your webhook URL has been set to "{}"'.format("https://097f773f.ngrok.io/hook"))
